...
3. The exercises will start and show the instructions automatically, butA if you encounter any issues you can try running them manually by typing in your command line the following:
...
Please create a python script that generates an excuse each time it is run.
